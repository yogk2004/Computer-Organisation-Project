...
def Def_Error(code_org):
    ...
    for list_line in code_org:
        if list_line!=[]:
            ...
            elif list_line[0]=="add" or list_line[0]=="sub" or list_line[0]=="mul" or list_line[0]=="xor" or list_line[0]=="or" or list_line[0]=="and" or list_line[0]=="mov" or list_line[0]=="rs" or list_line[0]=="ls" or list_line[0]=="mov" or list_line[0]=="div" or list_line[0]=="not" or list_line[0]=="cmp" or list_line[0]=="ld" or list_line[0]=="st" or list_line[0]=="jmp" or list_line[0]=="jlt" or list_line[0]=="jgt" or list_line[0]=="je" or list_line[0]=="hlt" or list_line[0]=="var" or list_line[0]=="nop":
                pass
    ...
    for list_line in code_org:
        var_flag2=0
        if list_line!=[] and list_line!=["hlt"] and list_line!=["nop"]:
    ...
    list_inst=["add","sub","mul","xor","or","and","mov","rs","ld","ls","div","not","cmp","Id","st","jmp","jlt","jgt","je","hlt","var","nop"]
    ...
    for list_line in code_org:
        if list_line!=[]:
            if list_line[0]=="var" or list_line[0]=="add" or list_line[0]=="sub" or list_line[0]=="mul" or list_line[0]=="xor" or list_line[0]=="or" or list_line[0]=="and" or list_line[0]=="mov" or list_line[0]=="rs" or list_line[0]=="ls" or list_line[0]=="mov" or list_line[0]=="div" or list_line[0]=="not" or list_line[0]=="cmp" or list_line[0]=="ld" or list_line[0]=="st" or list_line[0]=="jmp" or list_line[0]=="jlt" or list_line[0]=="jgt" or list_line[0]=="je" or list_line[0]=="hlt" or list_line[0]=="nop":
                continue
            else:
                if len(list_line)>=1:
                    if list_line[0][-1]==":":
    ...
    # Missing nop instruction
    for i in range(len(code_org)-1):
        cur_l=code_org[i]
        nx_l=code_org[i+1]
        if(cur_l==["jmp"] or cur_l==["jlt"] or cur_l==["jgt"] or cur_l==["je"] ):
            if(nx_l!=["nop"]):
                line_num=i+2
                Flag.append(["Missing nop instruction after",line_num])
        if(code_org[-1]==["jmp"] or code_org[-1]==["jlt"] or code_org==["jgt"] or code_org==["je"]):
            line_num=len(code_org)
            Flag.append(["Missing hlt instructions after",line_num])
...
def printing_machinecode(assembly_code,list_var_add,list_label_add):
    for list_line in assembly_code:
        ...
        #Type F instructions:
        elif list_line[0]=="hlt":
            print("1101000000000000")
        elif(list_line[0]=="nop"):
            print("1101100000000000")
            return
