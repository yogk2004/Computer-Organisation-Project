                ...
                if list_line[0]==label_name:
                    if len(list_line)>1:
                        if list_line[1]=="add" or list_line[1]=="sub" or list_line[1]=="mul" or list_line[1]=="xor" or list_line[1]=="or" or list_line[1]=="and" or list_line[1]=="mov" or list_line[1]=="rs" or list_line[1]=="ls" or list_line[1]=="mov" or list_line[1]=="div" or list_line[1]=="not" or list_line[1]=="cmp" or list_line[1]=="ld" or list_line[1]=="st" or list_line[1]=="jmp" or list_line[1]=="jlt" or list_line[1]=="jgt" or list_line[1]=="je" or list_line[1]=="hlt" or list_line[1]=="var":
                            ...
                            Flag.append(["No instruction after label",line_num])
                    else:
                        line_num=code_org.index(list_line)+1
                        Flag.append(["No instruction after label",line_num])
            ...
            if len(list_line)>2:
                if (list_line[0]=="mov" and list_line[2][0]!="$") or (list_line[1]=="mov"and list_line[3][0]!="$"):
                    ...
                    for j in list_line:
                        if j=="FLAGS":
                            line_num=code_org.index(list_line)+1
                            Flag.append(["Illegal use of FLAGS register",line_num])
            else:
                line_num=code_org.index(list_line)+1
                Flag.append(["Illegal use of FLAGS register",line_num])
        ...
        if list_line!=[]:
            if list_line[0]=="add" or list_line[0]=="sub" or list_line[0]=="mul" or list_line[0]=="xor" or list_line[0]=="or" or list_line[0]=="and" or list_line[0]=="mov" or list_line[0]=="rs" or list_line[0]=="ls" or list_line[0]=="mov" or list_line[0]=="div" or list_line[0]=="not" or list_line[0]=="cmp" or list_line[0]=="ld" or list_line[0]=="st" or list_line[0]=="jmp" or list_line[0]=="jlt" or list_line[0]=="jgt" or list_line[0]=="je" or list_line[0]=="hlt" or list_line[0]=="var":
                ...
                if len(list_line)>1:
                    if list_line[1]==":":
                        line_num=code_org.index(list_line)+1
                        Flag.append(["Space between label and colon",line_num])
    ...
    for list_line in code_org:
        if list_line!=[]:
            if list_line[0]=="var":
                ...
                if var_flag==1:
                    line_num=code_org.index(list_line)+1
                    Flag.append(["Not defining all variables in the starting",line_num])
            else:
                var_flag=1
    ...
    for list_line in code_org:
        ...
        if list_line!=[] and list_line!=["hlt"]:
            ...
            if list_line[0]=="ld" or list_line[0]=="st":
                if var_flag2==0:
                    line_num=code_org.index(list_line)+1
                    Flag.append(["Use of undefined variables",line_num])
            if len(list_line)>1:
                    ...
                    if i=="mov" or i=="rs" or i=="ls" or i=="ld" or i=="st":
                        ...
                        if len(list_line)==3:
                            ...
                            if count_reg<1 and status!="No pass":
                                ...
                                break
            if Flag_inst==0:
                if list_line[0] in list_label and len(list_line)>1:
                    for i in list_inst:
                        if list_line[1]==i:
                            Flag_inst=1
                            count_reg=0
    ...
    for list_line in code_org:
        ...
        if list_line!=[]:
            if list_line[0]=="var" or list_line[0]=="add" or list_line[0]=="sub" or list_line[0]=="mul" or list_line[0]=="xor" or list_line[0]=="or" or list_line[0]=="and" or list_line[0]=="mov" or list_line[0]=="rs" or list_line[0]=="ls" or list_line[0]=="mov" or list_line[0]=="div" or list_line[0]=="not" or list_line[0]=="cmp" or list_line[0]=="ld" or list_line[0]=="st" or list_line[0]=="jmp" or list_line[0]=="jlt" or list_line[0]=="jgt" or list_line[0]=="je" or list_line[0]=="hlt":
                ...
                if list_line[0] in list_label:
                    label_flag=1
                if label_flag==0:
                    line_num=code_org.index(list_line)+1
                    code_org[(line_num-1)]=[list_line[0],"",""]
                    Flag.append(["Use of undefined Labels",line_num])
        ...
        if list_line!=[] and list_line!=["hlt"]:
            if (list_line[0]=="rs" or list_line[0]=="ls" or list_line[0]=="mov"):
                if list_line[2][0]=="$":
                    ...
                    if num>=218 or num<0:
                        line_num=code_org.index(list_line)+1
                        Flag.append(["Illegal use of immediate value",line_num])
            if len(list_line)>1:
        ...
        for list_line in code_org:
            if list_line!=[]:
                if list_line[0]==label_name:
                    ...
                    if count>1:
                        line_num=code_org.index(list_line)+1
                        Flag.append(["Label used at multiple times",line_num])
...
def label_code(list_org):
    ...
    for list_line in list_org:
        if list_line!=[]:
            if list_line[0]=="jmp" or list_line[0]=="jlt" or list_line[0]=="jgt" or list_line[0]=="je":
                list_label_add.append([list_line[1]+":"])
            elif list_line[0]=="add" or list_line[0]=="sub" or list_line[0]=="mul" or list_line[0]=="xor" or list_line[0]=="or" or list_line[0]=="and" or list_line[0]=="mov" or list_line[0]=="rs" or list_line[0]=="ls" or list_line[0]=="mov" or list_line[0]=="div" or list_line[0]=="not" or list_line[0]=="cmp" or list_line[0]=="ld" or list_line[0]=="st" or list_line[0]=="jmp" or list_line[0]=="jlt" or list_line[0]=="jgt" or list_line[0]=="je" or list_line[0]=="hlt":
                pass
            else:
                if list_line[1]=="jmp" or list_line[1]=="jlt" or list_line[1]=="jgt" or list_line[1]=="je":
                    list_label_add.append([list_line[2]+":"])
    
    for list_line in list_org:
        if list_line!=[]:
            count_line+=1
            for temp_num in range(len(list_label_add)):
                if list_line[0]==list_label_add[temp_num][0]:
                    list_label_add[temp_num].append((BinaryGen(count_line,"n")))
...
def printing_machinecode(assembly_code,list_var_add,list_label_add):
    ...
    for list_line in assembly_code:
        ...
        if list_line[0]=="mov" or list_line[0]=="div" or list_line[0]=="not" or list_line[0]=="cmp":
            ...
            if list_line[0]=="mov" and (list_line[2]=="R1" or list_line[2]=="R2" or list_line[2]=="R3" or list_line[2]=="R4" or list_line[2]=="R5" or list_line[2]=="R6" or list_line=="FLAGS"):
                print("00011",end="")
        ...
        #Type E instructions:
        if list_line[0]=="jmp" or list_line[0]=="jlt" or list_line=="jgt" or list_line=="je":
            if list_line[0]=="jmp":
                print("01111",end="")
                #Printing Unused Bit:
                print("0000",end="")
...
for i in Def_Error(list_org):
    if i[0]=="Space between label and colon":
        flag_error="Yes"
        f.write("Spacing Error between label and colon at ")
        f.write(str(i[1]))
        f.write("\n")
    if i[0]=="Not defining all variables in the starting":
        flag_error="Yes"
        f.write("Variable not declared at the beginning at ")
        f.write(str(i[1]))
        f.write("\n")
    if i[0]=="Use of undefined variables":
        flag_error="Yes"
        f.write("Use of undefined variables ")
        f.write(str(i[1]))
        f.write("\n")
    if i[0]=="Label used at multiple times":
        flag_error="Yes"
        for j in i:
            f.write(str(j)+" ")
        f.write("\n")
    if i[0]=="No instruction after label":
        flag_error="Yes"
        for j in i:
            f.write(str(j)+" ")
        f.write("\n")
    if i[0]=="Use of undefined Labels":
        flag_error="Yes"
        for j in i:
            f.write(str(j)+" ")
        f.write("\n")
    if i[0]=="Illegal use of FLAGS register":
        flag_error="Yes"
        for j in i:
            f.write(str(j)+" ")
        f.write("\n")
    if i[0]=="Illegal use of immediate value":
        flag_error="Yes"
        for j in i:
            f.write(str(j)+" ")
        f.write("\n")
